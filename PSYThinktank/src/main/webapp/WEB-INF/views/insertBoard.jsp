		...
		<div class="border rounded-3 p-3">
			<form action="board" method="post">
				<div class="mb-3 mt-3">
					...
					<input type="text" class="form-control" id="title" name="boardTitle" size="135" maxlength="200" required>
				</div>
				<div class="mb-3 mt-3">
					<label for="comment">내용</label>
					<textarea class="form-control" rows="5" id="comment" name="boardContent" rows="20" cols="100"></textarea> 
				</div>
